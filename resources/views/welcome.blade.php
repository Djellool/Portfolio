...
<head>
    <meta charset="utf-8">
    <title>Boutouili Djillali</title>
...
<nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll" href="#page-top">Boutouili Djillali</a>
...
<!--/ Intro Skew Star /-->
<div id="home" class="intro route bg-image" style="background-image: url({{asset('img/Mouzaoui.jpg')}})">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-sm-6 col-md-5">
                                    <div class="about-img">
                                        <img src="{{asset('img/professional.png')}}" class="img-fluid rounded b-shadow-a" alt="">
                                    </div>
                                </div>
...
<div id="animatedModal2" class="popup-modal">
    <!--THIS IS IMPORTANT! to close the modal, the class name has to match the name given on the ID -->
    <div id="btn-close-modal" class="close-animatedModal2 " style="float: right ; margin: 20px;
    font-size: 22px;
...
<div id="animatedModal3" class="popup-modal">
    <!--THIS IS IMPORTANT! to close the modal, the class name has to match the name given on the ID -->
    <div id="btn-close-modal" class="close-animatedModal3" style="float: right ; margin: 20px;
    font-size: 22px;
    cursor: pointer;"> <i class="ion-close-round"></i> </div>
    <div class="clearfix"></div>
    <div class="container">
...
<div id="animatedModal4" class="popup-modal">
    <!--THIS IS IMPORTANT! to close the modal, the class name has to match the name given on the ID -->
    <div id="btn-close-modal" class="close-animatedModal4" style="float: right ; margin: 20px;
    font-size: 22px;
    cursor: pointer;"> <i class="ion-close-round"></i> </div>
    <div class="clearfix"></div>
    <div class="modal-content">
        <div class="container">
            <div class="portfolio-padding">
                <div class="col-md-8 col-md-offset-2">
                    <h2>Stock & Sales<br /> Mobile Application</h2>
                    <div class="h-50"></div>
                    <p>Stock&Sales is a Mobile Application built  , I created for the profit of a local delivery business in my city, Giving the company a fluid and fast way to manage all its stock and clients</p>
                    <p> Stock&Sales is a very well designed Mobile application that Contains all the functionalities a delivery company needs to manage its stock and delivery processes such as Client management , product management , Stock management , delivery planificication and even sales management</p>
                    <br/>
                    <div class="row">
                        <div class="col-md-6 col-sm-6  ">
                            <a class="mobile"> <img src="{{asset('img/SS1.PNG')}}" alt="image" class="img-responsive" />
                            </a>
                        </div>
                        <div class="col-md-6 col-sm-6  ">
                            <a class="mobile"> <img src="{{asset('img/SS2.PNG')}}" alt="image" class="img-responsive" />
                            </a>
                        </div>
                    </div>
                    <br/>
                    <div class="row">
                        <div class="col-md-6 col-sm-6  ">
                            <a class="mobile"> <img src="{{asset('img/SS3.PNG')}}" alt="image" class="img-responsive" />
                            </a>
                        </div>
                        <div class="col-md-6 col-sm-6  ">
                            <a class="mobile"> <img src="{{asset('img/SS4.PNG')}}" alt="image" class="img-responsive" />
                            </a>
                        </div>
                    </div>
                    <br/>
                    <br>
                    <p>Built using the Flutter framework built by Dart  which makes it fast and very performing, And using Firebase Firestore storing sysem built around the NoSQL paradigm on the cloud.</p>
                    <br/> </div>
            </div>
        </div>
    </div>
                    ...
                    <div id="contact" class="box-shadow-full">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="more-info">
                                    <p class="lead">
                                        On a personal level , I am a last year Computer Science Student in The Higher National School of computer Science of Algeria. <br>
                                        Interested In me ? don't hesitate to contact me , you won't be disappointed.

                                    </p>
                                    <ul class="list-ico">
                                        <li><span class="ion-ios-location"></span> Birkhadem , Algiers , Algeria</li>
                                        <li><span class="ion-ios-telephone"></span> (+213) 781846277</li>
                                        <li><span class="ion-email"></span> gd_boutouili@esi.dz</li>
                                    </ul>
                                </div>
                                <div class="socials">
                                    <ul>
                                        <li><a href="https://www.facebook.com/djillali.boutouili/"><span class="ico-circle"><i class="ion-social-facebook"></i></span></a></li>
                                        <li><a href="https://github.com/Djellool"><span class="ico-circle"><i class="ion-social-github"></i></span></a></li>
                                        <li><a href="https://www.linkedin.com/in/boutouili-djillali-850497158/"><span class="ico-circle"><i class="ion-social-linkedin"></i></span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
